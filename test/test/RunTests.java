...
import p1.AggregateStatesTest;
import p1.TemperatureConverterTest;
import p2.BMICalculatorTest;
import p2.BMICategoryTest;
...
public class RunTests {
	...
	public static void main(String[] args) {
		runTestsForClass(AggregateStatesTest.class);
		runTestsForClass(TemperatureConverterTest.class);
		runTestsForClass(BMICalculatorTest.class);
		runTestsForClass(BMICategoryTest.class);
	}
